...
export const messages = pgTable("messages", {
  id: serial("id").primaryKey(),
  from_user_id: integer("from_user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
  to_user_id: integer("to_user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
